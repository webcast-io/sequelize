...
module.exports = (function() {
  ...
  Migrator.prototype.migrate = function(options) {
    var self = this
    console.log('migrate options', options);
    options = Utils._.extend({
      method: 'up'
    }, options || {})

    return new Utils.CustomEventEmitter(function(emitter) {
      self.getUndoneMigrations(options, function(err, migrations) {
        if (err) {
  ...
  Migrator.prototype.getUndoneMigrations = function(options, callback)  {
    var self = this
    ...
    var migrationFiles = fs.readdirSync(options.path).filter(function(file) {
      return options.filesFilter.test(file)
    })
